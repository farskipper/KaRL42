...
var grammar = {
    ...
    {"name": "rule$ebnf$1$subexpression$1$string$1", "symbols": [{"literal":"p"}, {"literal":"r"}, {"literal":"e"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "rule$ebnf$1$subexpression$1", "symbols": ["rule$ebnf$1$subexpression$1$string$1", "_", "declaration_block", "_"]},
    ...
    {"name": "rule$ebnf$2$subexpression$1", "symbols": ["RuleActionBlock", "_"]},
    ...
    {"name": "rule$ebnf$3$subexpression$1", "symbols": ["RulePostlude", "_"]},
    ...
    {"name": "rule", "symbols": ["rule$string$1", "__", "Identifier", "_", {"literal":"{"}, "_", "rule$string$2", "__", "rule$string$3", "__", "EventExpression", {"literal":";"}, "rule$ebnf$1", "rule$ebnf$2", "rule$ebnf$3", {"literal":"}"}]},
    ...
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$7", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}], "postprocess": complexEventOp("max", 0, 6)},
    {"name": "event_exp_fns$string$8", "symbols": [{"literal":"m"}, {"literal":"i"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$8", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}], "postprocess": complexEventOp("min", 0, 6)},
    {"name": "event_exp_fns$string$9", "symbols": [{"literal":"s"}, {"literal":"u"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$9", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}], "postprocess": complexEventOp("sum", 0, 6)},
    {"name": "event_exp_fns$string$10", "symbols": [{"literal":"a"}, {"literal":"v"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$10", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}], "postprocess": complexEventOp("avg", 0, 6)},
    {"name": "event_exp_fns$string$11", "symbols": [{"literal":"p"}, {"literal":"u"}, {"literal":"s"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$11", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}], "postprocess": complexEventOp("push", 0, 6)},
    ...
    {"name": "event_exp_base", "symbols": ["Identifier", "__", "Identifier", "__", "event_exp_attribute_pairs", "event_exp_base$ebnf$1", "event_exp_base$ebnf$2"]},
