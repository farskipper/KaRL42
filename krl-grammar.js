...
var grammar = {
    ...
    {"name": "event_exp_where", "symbols": ["Expression"]},
    ...
    {"name": "exp_comp", "symbols": ["exp_comp", "__", "exp_comp$string$8", "__", "exp_sum"]},
    {"name": "exp_comp$string$9", "symbols": [{"literal":"<"}, {"literal":"="}, {"literal":">"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "exp_comp", "symbols": ["exp_comp", "__", "exp_comp$string$9", "__", "exp_sum"]},
