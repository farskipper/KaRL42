...
var grammar = {
    ...
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$1", "_", {"literal":"("}, "_", "EventExpression", "_", {"literal":","}, "_", "EventExpression", "_", {"literal":")"}]},
    ...
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$2", "__", "event_exp_fns$string$3", "_", {"literal":"("}, "_", "EventExpression", "_", {"literal":","}, "_", "EventExpression", "_", {"literal":")"}]},
    {"name": "event_exp_fns$string$4", "symbols": [{"literal":"a"}, {"literal":"n"}, {"literal":"y"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns$string$4", "__", "PositiveInteger", "_", {"literal":"("}, "_", "EventExpression_list", "_", {"literal":")"}]},
    ...
    {"name": "event_exp_fns", "symbols": ["event_exp_fns$string$5", "__", "PositiveInteger", "_", {"literal":"("}, "_", "EventExpression", "_", {"literal":")"}]},
    ...
    {"name": "event_exp_fns", "symbols": ["event_exp_fns$string$6", "__", "PositiveInteger", "_", {"literal":"("}, "_", "EventExpression", "_", {"literal":")"}]},
    {"name": "event_exp_fns$string$7", "symbols": [{"literal":"m"}, {"literal":"a"}, {"literal":"x"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$7", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}]},
    {"name": "event_exp_fns$string$8", "symbols": [{"literal":"m"}, {"literal":"i"}, {"literal":"n"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$8", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}]},
    {"name": "event_exp_fns$string$9", "symbols": [{"literal":"s"}, {"literal":"u"}, {"literal":"m"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$9", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}]},
    {"name": "event_exp_fns$string$10", "symbols": [{"literal":"a"}, {"literal":"v"}, {"literal":"g"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$10", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}]},
    {"name": "event_exp_fns$string$11", "symbols": [{"literal":"p"}, {"literal":"u"}, {"literal":"s"}, {"literal":"h"}], "postprocess": function joiner(d) {return d.join('');}},
    {"name": "event_exp_fns", "symbols": ["event_exp_fns", "__", "event_exp_fns$string$11", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}]},
    ...
    {"name": "event_exp_attribute_pairs", "symbols": []},
    ...
    {"name": "RuleAction", "symbols": ["RuleAction$ebnf$1", "Identifier", "_", {"literal":"("}, "_", "Expression_list", "_", {"literal":")"}, "RuleAction$ebnf$2"]},
    ...
    {"name": "postlude_clause", "symbols": [{"literal":"{"}, "_", "Statement_list", "_", {"literal":"}"}]},
    ...
    {"name": "exp_comp", "symbols": ["exp_comp", "_", "exp_comp$string$10", "_", "exp_sum"]},
    ...
    {"name": "Function", "symbols": ["Function$string$1", "_", {"literal":"("}, "_", "function_params", "_", {"literal":")"}, "_", {"literal":"{"}, "_", "Statement_list", "_", {"literal":"}"}]},
    ...
    {"name": "Application", "symbols": ["MemberExpression", "_", {"literal":"("}, "_", "Expression_list", "_", {"literal":")"}]},
    {"name": "Array", "symbols": [{"literal":"["}, "_", "Expression_list", "_", {"literal":"]"}]},
    {"name": "Map", "symbols": [{"literal":"{"}, "_", "map_kv_pairs", "_", {"literal":"}"}]},
